                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('assets/images/icons/3dcube.svg') }}" class="w-5 h-5 flex shrink-0"
                            alt="icon">
                        <p class="text-sm text-ngekos-grey">{{ $room->square_fit }} sqft flat</p>
                    </div>
                    <hr class="border-[#F1F2F6]">
    ...
    <div
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            <div class="flex items-center justify-between">
                ...
                <p class="font-semibold">{{ $dataBooking['name'] }}</p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <p class="font-semibold">{{ $dataBooking['email'] }}</p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <p class="font-semibold">{{ $dataBooking['phone_number'] }}</p>
            </div>
        </div>
    </div>
    <div
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            <div class="flex items-center justify-between">
                ...
                <p class="font-semibold">{{ $dataBooking['duration'] }} Months</p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <p class="font-semibold">{{ \Carbon\Carbon::parse($dataBooking['start_date'])->isoFormat('D MMMM YYYY') }}
                </p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <p class="font-semibold">
                    {{ \Carbon\Carbon::parse($dataBooking['start_date'])->addMonths(intval($dataBooking['duration']))->isoFormat('D MMMM YYYY') }}
                </p>
            </div>
        </div>
    </div>
    <form action="{{ route('payment', $boardingHouse->slug) }}" class="relative flex flex-col gap-6 mt-5 pt-5">
